...
/// <summary>
/// Provides JSON serialization helpers for the <see cref="ProductServiceBenchmarksExtensions"/> class.
/// </summary>
public static class ProductServiceBenchmarksExtensionsJsonExtensions
{
    ...
    /// <summary>
    /// Converts the <see cref="ProductServiceBenchmarksExtensions"/> instance to a JSON string.
    /// </summary>
    /// <param name="value">The <see cref="ProductServiceBenchmarksExtensions"/> instance to convert.</param>
    ...
    /// <returns>A <see cref="ProductServiceBenchmarksExtensions"/> instance, or null if the JSON string is invalid.</returns>
    ...
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">The deserialized <see cref="ProductServiceBenchmarksExtensions"/> instance, or null if the JSON string is invalid.</param>
